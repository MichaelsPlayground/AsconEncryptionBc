...
public class AsconBcTest extends SimpleTest {
            ...
            throws Exception
    {
        ...
        InputStream src = AsconBcTest.class.getResourceAsStream("/org/bouncycastle/crypto/test/ascon/LWC_AEAD_KAT_" + filename + ".txt");
...
//                }
            ...
            throws Exception
    {
        ...
        InputStream src = AsconBcTest.class.getResourceAsStream("/org/bouncycastle/crypto/test/ascon/" + filename + "_LWC_HASH_KAT_256.txt");
        BufferedReader bin = new BufferedReader(new InputStreamReader(src));
        String line;
        byte[] ptByte;
        HashMap<String, String> map = new HashMap<String, String>();
